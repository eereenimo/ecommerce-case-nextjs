  ...
  return (
    <header className="w-full">
      ...
      <nav className="bg-white sticky top-0 z-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
            ...
            <div className="flex items-center gap-3 sm:gap-5">
              <button className="p-1 text-gray-700 hover:text-black transition-colors" aria-label="Search">
              ...
              <button className="p-1 text-gray-700 hover:text-black transition-colors" aria-label="Account">
              ...
              <Link href="/cart" className="p-1 text-gray-700 hover:text-black relative transition-colors" aria-label="Cart">
        ...
        <div className={`lg:hidden bg-white border-t border-gray-100 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
          <div className="px-4 py-6 space-y-4">
            ...
            <div className="pt-6 border-t border-gray-100 flex flex-col gap-4">
              <button className="flex items-center gap-3 text-gray-700 font-medium" aria-label="Account">
